...
public class #(firstCharToUpperCase(toCamelCase(tableName)))DTO {
    ...
    private #(toJavaType(x.data_type)) #(toCamelCase(x.column_name));
    #end

    #for(x : columnList)
    public #(toJavaType(x.data_type)) get#(firstCharToUpperCase(toCamelCase(x.column_name)))() {
      return #(toCamelCase(x.column_name));
    }
    public void set#(firstCharToUpperCase(toCamelCase(x.column_name)))(#(toJavaType(x.data_type)) #(toCamelCase(x.column_name))) {
