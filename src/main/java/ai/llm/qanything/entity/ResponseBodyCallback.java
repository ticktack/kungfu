...
import ai.llm.qanything.QanythingClient;
import ai.llm.qanything.exception.AiSdkException;
...
public class ResponseBodyCallback implements Callback<ResponseBody> {
    private static final ObjectMapper mapper = QanythingClient.defaultObjectMapper();
        ...
        try {
            if (!response.isSuccessful()) {
                ...
                if (errorBody == null) {
                    ...
                    throw new AiSdkException("-1", error, null);
                }
            }
