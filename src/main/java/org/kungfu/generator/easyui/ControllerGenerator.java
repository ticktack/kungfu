...
public class ControllerGenerator {
	...
	protected String saveOrUpdateTemplate =
			...
			"\t\tString successMessage = MsgKit.message(model.getId(), Constants.SUCCESS_MASSAGE);%n" +
			"\t\tString errorMessage = MsgKit.message(model.getId(), Constants.ERROR_MASSAGE);%n%n" +
	...
	protected String deleteTemplate =
			...
			"\t\t\tsuccess(Constants.SUCCESS_DELETE);%n" +
			"\t\telse%n" +
			"\t\t\terror(Constants.ERROR_DELETE);%n" +
			"\t}%n%n";
