...
public class ServiceGenerator {
	...
	protected String pageSampleTemplate =
			...
			"\t\treturn %s.dao.page(pageNumber, pageSize);%n" +
			"\t}%n%n";
	...
	protected String pageClauseTemplate =
			...
			"\t\treturn %s.dao.page(pageNumber, pageSize, orderField, orderDirection, where);%n" +
			"\t}%n%n";
	
	protected String saveOrUpdateTemplate =
			"\t@Override%n" + 
			"\tpublic boolean saveOrUpdate(%s model) {%n" +
	...
	protected String deleteTemplate =
			...
			"\t\treturn %s.dao.deleteById(idValue);%n" +
			"\t}%n%n";
